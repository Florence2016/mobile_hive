define(['dart_sdk', 'packages/angular/src/core/change_detection/change_detection', 'packages/mobile_hive/in_memory_data_service', 'packages/angular_router/src/directives/router_outlet_directive', 'packages/http/src/base_client', 'packages/angular/angular.template', 'packages/angular_router/angular_router.template', 'packages/mobile_hive/app_component.template', 'packages/mobile_hive/in_memory_data_service.template', 'packages/mobile_hive/app_component', 'packages/angular/src/bootstrap/modules'], function(dart_sdk, change_detection, in_memory_data_service, router_outlet_directive, base_client, angular, angular_router, app_component, in_memory_data_service$, app_component$, modules) {
  'use strict';
