define(['dart_sdk', 'packages/fixnum/fixnum'], function(dart_sdk, fixnum) {
  ...
  dart.setMethodSignature(protobuf.BuilderInfo, () => ({
    ...
    m: dart.gFnType(T => [dart.void, [core.int, core.String, dart.fnType(protobuf.GeneratedMessage, []), dart.fnType(dart.dynamic, [])]]),
  ...
  protobuf.FieldInfo$ = dart.generic(T => {
    ...
    class FieldInfo extends core.Object {
      ...
      get readonlyDefault() {
        if (dart.test(this.isRepeated)) return const$ || (const$ = dart.constList([], core.Null));
        return this.makeDefault();
      }
  ...
  protobuf._FieldSet = class _FieldSet extends core.Object {
    ...
    [_getDefaultList](T, fi) {
      if (!dart.test(fi.isRepeated)) dart.assertFailed();
      if (dart.test(this[_isReadOnly])) return core.List$(T).unmodifiable(const$0 || (const$0 = dart.constList([], dart.dynamic)));
    ...
    [_$set](index, value) {
      ...
      if (dart.test(this[_isReadOnly])) {
        dart.throw(new core.UnsupportedError.new("attempted to call a setter on a read-only message (" + dart.str(this[_messageName]) + ")"));
      }
      if (value == null) {
  ...
  protobuf.PbList$ = dart.generic(E => {
    ...
    class PbList extends collection.ListBase$(E) {
      ...
      static forFieldType(fieldType) {
        return new (PbListOfE()).new({check: protobuf.getCheckFunction(fieldType)});
      }
      _equals(other) {
        if (other == null) return false;
  ...
  protobuf.ReadonlyMessageMixin = class ReadonlyMessageMixin extends core.Object {
    ...
    [_readonly](methodName) {
      ...
      dart.throw(new core.UnsupportedError.new("attempted to call " + dart.str(methodName) + " on a read-only message (" + dart.str(messageType) + ")"));
    }
  };
  ...
  protobuf._ReadonlyUnknownFieldSet = class _ReadonlyUnknownFieldSet extends protobuf.UnknownFieldSet {
    ...
    [_readonly](methodName) {
      dart.throw(new core.UnsupportedError.new("attempted to call " + dart.str(methodName) + " on a read-only UnknownFieldSet"));
    }
  };
